...
var _path$ad;
function _extends$ad() { return _extends$ad = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends$ad.apply(null, arguments); }
var SvgEnderecofield = function SvgEnderecofield(props) {
  return /*#__PURE__*/React.createElement("svg", _extends$ad({
    xmlns: "http://www.w3.org/2000/svg",
    width: 48,
    height: 48,
    fill: "currentcolor",
  }, props), _path$ad || (_path$ad = /*#__PURE__*/React.createElement("path", {
    fillRule: "evenodd",
    d: "M27 5C17.06 5 9 13.06 9 23c0 11.65 18 26 18 26s18-14.35 18-26c0-9.94-8.06-18-18-18zm0 24a6 6 0 1 1 0-12 6 6 0 0 1 0 12z"
  })));
};
  ...
  return jsxs(Fragment, {
    children: [jsxs("div", {
      ...
      children: [jsx("div", {
        ...
        id: `${domId}-display`,
        children: valueLabel || 'Lista de opções'
      }), !disabled && jsx("input", {
        ref: inputRef,
        id: domId,
...
const phoneMask = (value) => {
 ...
 function Enviar(props) {
  ...
  return jsxs("div", {
    className: classNames('fjs-form-field-group-enviar', {
      'fjs-outlined': showOutline
    }),
    role: "enviar",
    "aria-labelledby": domId,
    children: [jsx(ChildrenRenderer, {
      ...fullProps
    })]
  });
}
...
function FilePicker(props) {
  ...
  return jsxs("div", {
    ...
    children: [
      ...
      children: [
       jsx("span", {
        className: getClassFileSelect(selectedFiles),
        children: ''
      })
        ,jsx("button", {
        type: "button",
        disabled: isInputDisabled,
        readOnly: readonly,
        className: "fjs-filepicker-button-select",
        onClick: () => {
          fileInputRef.current.click();
        },
        children: `Selecionar ${label}`
      }), jsx("span", {
      ...
      jsx("p", {
        ...
        disabled: isInputDisabled,
        readOnly: readonly,
        className: "fjs-button fjs-filepicker-button-delete",
        onClick: () => {
          limparArquivos(fileRegistry, filesKey, fileInputRef, onChange)
        },
        children: getIconDelete(selectedFiles)
      })]
    }), jsx(Errors, {
      id: errorMessageId,
      errors: errors
...
function getClassFileSelect(files) {
  if (files.length === 0) {
    return 'fjs-form-field-label';
  }
  return 'fjs-form-field-label fjs-form-field-label-icon-check';
}

function limparArquivos(fileRegistry, filesKey, fileInputRef, onChange) {
  if (filesKey && fileRegistry) {
    fileRegistry.deleteFiles(filesKey);
  }
  ...
  return jsxs("div", {
    ...
    children: [jsx("div", {
      ...
      children: [jsx("a", {
        ...
        children: ["Ferramentas baseadas na web para BPMN, DMN e formulários fornecidas pela", ' ', jsx("a", {
          href: "https://bpmn.io",
          target: "_blank",
          rel: "noopener noreferrer",
          children: "bpmn.io"
    ...
    return jsxs("div", {
      ...
      children: [showAdd ? jsx("button", {
        ...
        children: jsxs(Fragment, {
          children: [jsx(SvgAdd, {}), " ", 'Adicionar novo']
        })
        ...
        children: isCollapsed ? jsxs(Fragment, {
          children: [jsx(SvgExpand, {}), " ", `Expandir todos (${values.length - 1})`]
        }) : jsxs(Fragment, {
          children: [jsx(SvgCollapse, {}), " ", 'Esconder']
        })
      }) : null]
    });
  }
...
function runPresetValidation(field, validation, value) {
  ...
  if (validation.pattern && value && !new RegExp(validation.pattern).test(value)) {
    errors.push(`O campo deve corresponder ao padrão ${validation.pattern}.`);
  }
  ...
  if ('min' in validation && (value || value === 0) && value < validation.min) {
    errors.push(`O campo deve ter o valor mínimo de ${validation.min}.`);
  }
  if ('max' in validation && (value || value === 0) && value > validation.max) {
    errors.push(`O campo deve ter o valor máximo de ${validation.max}.`);
  }
  if ('minLength' in validation && value && value.trim().length < validation.minLength) {
    errors.push(`O campo deve ter o comprimento mínimo de ${validation.minLength}.`);
  }
  if ('maxLength' in validation && value && value.trim().length > validation.maxLength) {
    errors.push(`O campo deve ter o comprimento máximo de ${validation.maxLength}.`);
  }
  if ('validationType' in validation && value && validation.validationType === 'phone' && !PHONE_PATTERN.test(value)) {
    errors.push('O campo deve ser um número de telefone internacional válido. (ex.: +4930664040900)');
  }
  if ('validationType' in validation && value && validation.validationType === 'email' && !EMAIL_PATTERN.test(value)) {
    errors.push('O campo deve ser um e-mail válido.');
  }
  return errors;
}
...
class FormLayouter {
  ...
  calculateLayout(formField) {
    ...
    if (!['default', 'group', 'dynamiclist', 'endereco', 'enviar'].includes(type) || !components) {
      return;
    }
