...
@Component({
  selector: 'app-process-duration-report',
  standalone: true,
  imports: [
    CommonModule,
    ChartModule,
  ...
  templateUrl: './process-duration-report.component.html',
  styleUrls: ['./process-duration-report.component.scss']
})
export class ProcessDurationReportComponent implements OnInit {
