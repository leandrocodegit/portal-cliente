import { PropertiesPanel, DebounceInputModule, FeelPopupModule, isTextAreaEntryEdited, TextAreaEntry, isTextFieldEntryEdited, TextFieldEntry, Group } from 'src/libs/properties-panel';
import { useState, useEffect, useMemo, useContext, useCallback } from 'src/libs/properties-panel/preact/hooks';
import { some, reduce, isArray, find, forEach, findIndex } from 'min-dash';
import { createContext, render } from 'src/libs/properties-panel/properties-panel/preact';
import * as React from 'src/libs/properties-panel/preact/compat';
import { jsx, jsxs } from 'src/libs/properties-panel/preact/jsx-runtime';
